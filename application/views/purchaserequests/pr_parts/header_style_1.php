<table style="color: #444; width: 100%;">
    <tr class="invoice-preview-header-row">
        ...
        <td class="invoice-info-container" style="width: 35%; vertical-align: top; text-align: right"><?php
            ...
            $this->load->view('purchaserequests/pr_parts/pr_info', $data);
            ?>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td><?php
            $this->load->view('purchaserequests/pr_parts/pr_from', $data);
            ?>
        </td>
        <td></td>
        <td>
			...
			<div><b><?php echo lang('buyer'); ?></b> <strong><?php echo $client_info->first_name.' '.$client_info->last_name; ?> </strong></div>
