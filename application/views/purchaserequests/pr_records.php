<div id="page-content" class="p20 clearfix">
    <div class="panel clearfix">
        ...
        <div class="tab-content" id="pr_records_content">
            <form id="pr_records_form" class="general-form" role="form">
                <div class="table-responsive">
                    <table id="pr_records_table" class="display" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                ...
                <div class="pr-records-footer clearfix">
...
<script type="text/javascript">
    ...
    const recordsForm = document.querySelector('#pr_records_form');
    recordsForm.addEventListener('submit', (event) => {
        ...
        let url = '<?php echo echo_uri('purchaserequests/pr_records_save'); ?>';
