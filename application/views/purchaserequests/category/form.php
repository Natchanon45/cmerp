<?php echo form_open(get_uri("purchaserequests/save_category"), array("id" => "pr-cat-form", "class" => "general-form", "role" => "form")); ?>
        ...
        $("#pr-cat-form").appForm({
            onSuccess: function (result) {
                ...
                /*if (typeof RELOAD_VIEW_AFTER_UPDATE !== "undefined" && RELOAD_VIEW_AFTER_UPDATE) {
                    ...
                    //window.location = "<?php echo site_url('purchaserequests/category_form'); ?>/" + result.id;
                    window.location = "<?php echo site_url('purchaserequests/categories'); ?>";
                }*/
            }
        });
