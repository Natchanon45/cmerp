    ...
    <?php if (true || $cart_items_count) { ?>
        <div class="process-pr-preview">
            <div class="panel panel-default">
                ...
                <?php echo form_open(get_uri("purchaserequests/place_order"), array("id" => "place-pr-form", "class" => "general-form", "role" => "form")); ?>

                <div class="page-title clearfix">
                    <h1> <?php echo lang('process_request_order'); ?></h1>
                    <div class="title-button-group">
                       <a href="<?php echo get_uri("purchaserequests");?>" class="btn btn-default"><?php echo lang('back_to_purchases1');?></a>
                    </div>
                </div>
                    ...
                    <div class="m15 pb15 mb30">
                        ...
                        <div class="clearfix">
                            ...
                            <div class="pull-right" id="pr-total-section">
                                <?php $this->load->view("purchaserequests/processing_pr_total_section"); ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="panel-footer clearfix">
                    ...
                    <?php }else{ ?>
                    <?php echo anchor( get_uri("purchaserequests/view/$pr_id"), "<i class='fa fa-check-circle'></i> " . lang('place_order'), array("class" => "btn btn-primary pull-right ml10")); ?> 
                    <?php } ?>
                    <?php echo modal_anchor(get_uri("purchaserequests/item_modal_form"), "<i class='fa fa-plus-circle'></i>" . lang('add_more_items'), array("class" => "btn btn-default pull-right", "title" => lang('add_more_items'), "data-post-id" => 0, "data-post-pr_id" => $pr_id,'data-post-item_type'=>'oth'));?>
                    ...
                    <?php echo modal_anchor(get_uri("purchaserequests/item_modal_form"), "<i class='fa fa-plus-circle'></i>" . lang('add_materials'), array("class" => "btn btn-default pull-right", "title" => lang('add_materials'), "data-post-id" => 0, "data-post-pr_id" => $pr_id,'data-post-item_type'=>'mtr'));?>
                </div>
