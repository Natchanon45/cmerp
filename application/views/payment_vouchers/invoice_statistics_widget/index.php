<div id="invoice-payment-statistics-container">
    <?php $this->load->view("payment_vouchers/invoice_statistics_widget/widget_data"); ?>
</div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $(".load-currency-wise-data").click(function () {
            ...
            $.ajax({
                url: "<?php echo get_uri('payment_vouchers/load_statistics_of_selected_currency') ?>" + "/" + currencyValue,
                type: 'POST',
                dataType: 'json',
