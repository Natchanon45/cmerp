<?php echo form_open(get_uri("payment_vouchers/save"), array("id" => "invoice-form", "class" => "general-form", "role" => "form")); ?>
<div id="invoices-dropzone" class="post-dropzone">
 ...
 <input type="hidden" name="invoice_client_id" value="0" />
        ...
        <div class="form-group">
            <label for="project_name" class=" col-md-3">ชื่อโครงการ</label>
            <div class=" col-md-9">
                <?php
                echo form_textarea(array(
                    "id" => "project_name",
                    "name" => "project_name",
                    "value" => $model_info->project_name ? $model_info->project_name : "",
                    "class" => "form-control",
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var uploadUrl = "<?php echo get_uri("payment_vouchers/upload_file"); ?>";
        var validationUri = "<?php echo get_uri("payment_vouchers/validate_invoices_file"); ?>";
        ...
        $("#invoice-form").appForm({
            onSuccess: function (result) {
                if (typeof RELOAD_VIEW_AFTER_UPDATE !== "undefined" && RELOAD_VIEW_AFTER_UPDATE) {
                    ...
                    window.location = "<?php echo site_url('payment_vouchers/view'); ?>/" + result.id;
                }
            },
        ...
        $("#invoice_client_id").select2().on("change", function () {
            ...
            if ($(this).val()) {
                ...
                $.ajax({
                    url: "<?php echo get_uri("payment_vouchers/get_project_suggestion") ?>" + "/" + client_id,
                    dataType: "json",
