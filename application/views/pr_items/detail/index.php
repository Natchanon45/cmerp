<div class="page-title clearfix no-border bg-off-white">
  <h1>
    <a class="title-back" href="<?php echo get_uri('items'); ?>">
...
<div id="page-content" class="clearfix">
  ...
  <ul id="client-tabs" data-toggle="ajax-tab" class="nav nav-tabs" role="tablist" style="background:#ffffff;">
    <li><a role="presentation" href="<?php echo_uri("items/detail_info/".$model_info->id); ?>" data-target="#item-info">
      <?php echo lang('item_details'); ?>
    </a></li>
    <?php if(!isset($hidden_menu) || !in_array('item-mixing', $hidden_menu)){?>
      <li><a role="presentation" href="<?php echo_uri("items/detail_mixings/".$model_info->id); ?>" data-target="#item-mixing">
