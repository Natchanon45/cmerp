<div id="page-content" class="p20 clearfix">
    <div class="clearfix mb15">
        ...
        <div class="pull-right custom-toolbar">
            <?php
            /*echo form_input(array(
    ...
    <div class="row" id="items-container">
        <?php $this->load->view("pr_items/items_grid_data",['pr_id'=>@$pr_id]); ?>
    </div>
</div>
...
<script>
    $(document).ready(function () {
        ...
        function getItemSuggestions() {
            ...
            $.ajax({
                url: "<?php echo get_uri('pr_items/grid_view/'); ?>",
                data: {search: $searchBox.val(), item_search: true, category_id: $itemCategoriesFilter.val(), pr_id:<?php echo @$pr_id?$pr_id:0;?>},
                cache: false,
                type: 'POST',
                dataType: 'json',
        ...
        $("body").on("click", ".item-add-to-cart-btn", function () {
            ...
            $.ajax({
                url: "<?php echo get_uri('pr_items/add_item_to_cart'); ?>" + "/" + itemId,
                data: {id: itemId, pr_id: <?php echo @$pr_id?$pr_id:0;?>},
                cache: false,
                type: 'POST',
                dataType: 'json',
                success: function (response) {
