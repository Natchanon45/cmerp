        ...
        if (count($files)) {
            if ($this->login_user->is_admin && get_setting("module_order")) {
                ...
                <div class="col-md-12 mt15">
                    ...
                    <?php $this->load->view("includes/sortable_file_list", array("files" => $model_info->files, "action_url" => get_uri("pr_items/save_files_sort"), "id" => $model_info->id)); ?>
                </div>
                <?php
            }
        }
...
<div class="modal-footer">
    ...
    if ($this->login_user->user_type == "staff") {
        echo modal_anchor(get_uri("pr_items/modal_form"), "<i class='fa fa-pencil'></i> " . lang('edit_item'), array("class" => "btn btn-default", "data-post-id" => $model_info->id, "title" => lang('edit_item')));
    }
    ?>
