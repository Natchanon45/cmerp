                    ...
                    <div class="cart-grid-item-image" style="background-image: url(<?php echo get_store_item_image($item->files); ?>)">
                        ...
                        <div class="cart-grid-item-details">
                            <div class="text-center">
                                <?php echo modal_anchor(get_uri("pr_items/view"), "<span class='view-item-details-link-btn'>" . lang("view_details") . "</span>", array("data-modal-title" => lang("item_details"), "data-post-id" => $item->id)); ?>
                            </div>
                        </div>
                    </div>
                    <div class="p15">
    ...
    <div id="<?php echo $next_container_id; ?>">
        <div class="text-center">
            ...
            if ($result_remaining > 0) {
                echo ajax_anchor(get_uri("pr_items/grid_view/" . $next_page_offset . "/20/" . $category_id . "/" . $search).'?pr_id='.@$pr_id, lang("load_more"), array("class" => "btn btn-default mt15 mb15 round pl15 pr15", "title" => lang("load_more"), "data-inline-loader" => "1", "data-real-target" => "#" . $next_container_id));
            }
            ?>
        </div>
    </div>
