<div id="page-content" class="p20 clearfix">
    ...
    <ul class="nav nav-tabs bg-white title" role="tablist">
        <li class="title-tab"><h4 class="pl15 pt10 pr15"><?php echo lang('tickets_own_list'); ?></h4></li>

        <?php $this->load->view("tickets/index", array("active_tab" => "tickets_own_list")); ?>
    ...
    <div class="panel panel-default">
        <div class="table-responsive pb50">
            <table id="ticket-own-table" class="display" cellspacing="0" width="100%">
	    </table>
        </div>
    </div>
...
<script type="text/javascript">
	$(document).ready(function () {
		...
		$("#ticket-own-table").appTable({
		source: '<?php echo_uri("tickets/list_data_own") ?>',
		order: [[6, "desc"]],
