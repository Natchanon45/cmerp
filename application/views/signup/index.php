    ...
    <div id="page-content" class="clearfix">
        <div class="scrollable-page">
            <div class="signin-box">
                <div class="panel panel-default clearfix ovf-hidden bradius bshadow">
                    <div class="panel-heading text-center d-block">
                    ...
                    <div class="panel-body">
                        ...
                        <?php if ($signup_type == "send_verify_email") { ?>
                            <div class="form-group">
                                <label for="email" class=" col-md-12"><?php echo lang('input_your_email'); ?></label>
                                <div class=" col-md-12">
                                    <?php
                        ...
                        <div class="form-group">
                            <div class=" col-md-12">
                                <button class="btn btn-lg btn-primary btn-block" type="submit"><?php echo $signup_type == "send_verify_email" ? lang("get_started") : lang('signup'); ?></button>
                            </div>
                        </div>
                    </div>
                    <?php echo form_close(); ?>
