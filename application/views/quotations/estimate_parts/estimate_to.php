<div><b><?php echo lang("client"); ?></b></div>
<!-- <div style="line-height: 2px; border-bottom: 1px solid #f2f2f2;"> </div> -->
<div style="line-height: 3px;"> </div>
<strong><?php echo $client_info->company_name.' '; 
   echo modal_anchor(get_uri("estimates/modal_form"), "<i class='fa fa-edit' style='color: blue'></i>", array("title" => lang('edit_estimate'), "data-post-id" => $estimate_info->id, "role" => "menuitem", "tabindex" => "-1"));
   ?> </strong>
<div style="line-height: 3px;"> </div>
