                ...
                <?php
                    if(get_array_value($this->login_user->permissions, "can_create_projects") == true || $this->login_user->is_admin == "1"){
                        if ($can_edit_projects) {
                            echo modal_anchor(get_uri("labels/modal_form"), "<i class='fa fa-tags'></i> " . lang('manage_labels'), array("class" => "btn btn-default", "title" => lang('manage_labels'), "data-post-type" => "project"));
                        }
...
<style>
    ...
    table#project-table > thead > tr > th:nth-child(2),
    table#project-table > tbody > tr > td:nth-child(2){display:table-cell!important;}
</style>