<div class="panel no-border">
    <div class="tab-title clearfix">
        ...
        <div class="title-button-group">
            ...
            if ($can_add_remove_project_members) {
                ...
                // echo modal_anchor(get_uri("projects/project_teams_member_modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_team'), array("class" => "btn btn-default", "title" => lang('select_a_team'), "data-post-project_id" => $project_id));
    ...
    <div class="table-responsive">
        <table id="project-teams-table" class="b-b-only no-thead display" cellspacing="0" width="100%">
        </table>
    </div>
</div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        //     source: '<?php echo_uri("projects/list_Teams/". $project_id) ?>',
        //     hideTools: true,
        //     displayLength: 500,
        //     columns: [                
        //         {title: ''},
