...
<div id="tasks-dropzone" class="post-dropzone">
    <div class="modal-body clearfix">
        ...
        <?php if ($show_assign_to_dropdown) { ?>
            ...
            <div class="form-group">
                <label for="collaboratorsTeam" class=" col-md-3">ร่วมงาน<?php echo lang('team'); ?></label>
                <div class="col-md-9">
                    
                    <?php
                    $team_select[''] = '-';
                    foreach($team as $k => $v){
                        $team_select[$v['id']] = $v['text'] ? $v['text'] : "-";                       

                    }
                    echo form_dropdown( "collaboratorsTeam", $team_select, array($model_info->team_id), "id='collaboratorsTeam' class = 'select2'");
                    ?>
                </div>
            </div>
        ...
        <div class="form-group">
            ...
            <div class=" col-md-9">
                ...
                echo form_input(array(
                    ...
                    "data-msg-greaterThanOrEqual" => lang("deadline_must_be_equal_or_greater_than_start_date")
                ));
                ?>
            </div>
        </div>
            ...
            <?php if ($has_sub_task) { ?>
                <div class="form-group">
                    <label for="copy_sub_tasks" class=" col-md-12">
                        <?php
                        echo form_checkbox("copy_sub_tasks", "1", false, "id='copy_sub_tasks' class='pull-left mr15'");
                        ?>    
                        <?php echo lang('copy_sub_tasks'); ?>
                    </label>
                </div>
            <?php } ?>
        <?php } ?>
