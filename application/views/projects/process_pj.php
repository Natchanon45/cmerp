    ...
    <?php if (true || @$cart_materials_count) { ?>
        <div class="process-pr-preview">
            <div class="panel panel-default">
                ...
                <?php echo form_open(get_uri("projects/place_order"), array("id" => "place-pr-form", "class" => "general-form", "role" => "form")); ?>
                <input type="hidden" name="mr_id" value="<?php echo $mr_id?>">
                <div class="page-title clearfix">
                    <h1> <?php echo lang('process_request_material'); ?></h1>
                    <div class="title-button-group">
                       <a href="<?php echo get_uri("projects/all_projects");?>" class="btn btn-default"><?php echo lang('back_to_list');?></a>
                    </div>
                </div>

                <div class="p20">
                    <div class="mb20 ml15 mr15"><?php echo lang("process_pr_info_message"); ?></div>
                ...
                <button type="submit" class="btn btn-primary pull-right ml10"><span class="fa fa-check-circle"></span> <?php echo lang('place_order_materialrequest'); ?></button>
                    ...
                    <?php }else{ ?>
                    <?php echo anchor( get_uri("materialrequests/view/$mr_id"), "<i class='fa fa-check-circle'></i> " . lang('place_order'), array("class" => "btn btn-primary pull-right ml10")); ?> 
                    <?php } */?>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $("#pr-item-table").appTable({
                    source: '<?php echo_uri("Projects/item_list_data_of_login_user".($mr_id?"/".$mr_id:"")) ?>',
                    order: [[0, "asc"]],
                    hideTools: true,
                    displayLength: 100,
                    columns: [
                        ...
                        {title: "<?php echo lang("quantity") ?>", "class": "text-center w10p", "bSortable": false},
                    ...
                    onDeleteSuccess: function (result) {
                        $("#pr-total-section").html(result.mr_total_view);
                    },
