...
<div class="modal-body clearfix">
    ...
    <div class="p3">
        <p style="font-size: 110%;"><?php echo lang("production_order_want_to_chage"); ?> <span class="pill pill-success"><?php echo lang("production_order_produced_completed"); ?></span> <?php echo lang("production_order_all_of_order"); ?></p>
    </div>
</div>
