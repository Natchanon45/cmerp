<?php echo form_open(get_uri("receive_vouchers/save"), array("id" => "invoice-form", "class" => "general-form", "role" => "form")); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var uploadUrl = "<?php echo get_uri("receive_vouchers/upload_file"); ?>";
        var validationUri = "<?php echo get_uri("receive_vouchers/validate_invoices_file"); ?>";
        ...
        $("#invoice-form").appForm({
            onSuccess: function (result) {
                if (typeof RELOAD_VIEW_AFTER_UPDATE !== "undefined" && RELOAD_VIEW_AFTER_UPDATE) {
                    ...
                    window.location = "<?php echo site_url('receive_vouchers/view'); ?>/" + result.id;
                }
            },
        ...
        $("#invoice_client_id").select2().on("change", function () {
            ...
            if ($(this).val()) {
                ...
                $.ajax({
                    url: "<?php echo get_uri("receive_vouchers/get_project_suggestion") ?>" + "/" + client_id,
                    dataType: "json",
