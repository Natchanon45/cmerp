    ...
    <div class="panel clearfix">
        <ul id="invoices-tabs" data-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
		   ...
		   <li class="title-tab"><h4 class="pl15 pt10 pr15"><?php echo lang("payment_vouchers"); ?></h4></li>
            ...
            <li><a role="presentation" href="<?php echo_uri("receive_vouchers/yearly/"); ?>" data-target="#yearly-invoices"><?php echo lang('yearly'); ?></a></li>
            <li><a role="presentation" href="<?php echo_uri("receive_vouchers/custom/"); ?>" data-target="#custom-invoices"><?php echo lang('custom'); ?></a></li>
            <li><a role="presentation" href="<?php echo_uri("receive_vouchers/recurring/"); ?>" data-target="#recurring-invoices"><?php echo lang('recurring'); ?></a></li>
...
<script type="text/javascript">
    ...
    $(selector).appTable({
    source: '<?php echo_uri("receive_vouchers/list_data") ?>',
            dateRangeType: dateRange,
            order: [[0, "desc"]],
            filterDropdown: [
            {name: "status", class: "w150", options: <?php $this->load->view("receive_vouchers/invoice_statuses_dropdown"); ?>},
...
<?php } ?>
            ...
            columns: [
            {title: "<?php echo lang("payment_voucher_id") ?>", "class": "w10p"},
