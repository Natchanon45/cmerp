        ...
        <div class="process-order-preview">
            <div class="panel panel-default">
                ...
                <div class="p20">
                    ...
                    <label for="client_id" class=" col-md-12"><?php echo lang( 'labels' ); ?></label>
                    ...
                    <div class="form-group">
                        <label for="order_tax_id" class=" col-md-12"><?php echo lang('tax'); ?></label>
                        <div class="col-md-12">
                            <?php
                            echo form_dropdown("order_tax_id", $taxes_dropdown, array(), "class='select2 tax-select2'");
                            ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="order_tax_id2" class=" col-md-12"><?php echo lang('second_tax'); ?></label>
                        <div class="col-md-12">
                            <?php
                            echo form_dropdown("order_tax_id2", $taxes_dropdown, array(), "class='select2 tax-select2'");
                            ?>
                        </div>
                    </div>

                    <div class="form-group clearfix">
                        <label for="order_note" class=" col-md-12"><?php echo lang('note'); ?></label>
                        <div class=" col-md-12">
                            <?php
