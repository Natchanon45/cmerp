<div id="page-content" class="clearfix">
    <div style="max-width: 1000px; margin: auto;">
        <div class="page-title clearfix mt15">
            <h1><?php echo get_order_id($order_info->doc_no); ?></h1>
            <div class="title-button-group">
                ...
                <span class="dropdown inline-block">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li role="presentation"><?php echo anchor(get_uri("pdf_export/order_pdf/" . $order_info->id), "<i class='fa fa-download'></i> " . lang('download_pdf'), array("title" => lang('download_pdf'),)); ?> </li>
        ...
        <div id="order-status-bar">
            ...
            <?php echo $this->dao->getDocLabels($order_info->id); ?>
        </div>
        <div class="mt15">
