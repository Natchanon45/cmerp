<span style="font-size:20px; font-weight: bold;background-color: <?php echo $color; ?>; color: #fff;">&nbsp;<?php echo get_order_id($order_info->doc_no); ?>&nbsp;</span>
...
?>
<span><?php echo lang("order_date") . ": " . format_to_date($order_info->order_date, false); ?></span>