    ...
    <div class="form-group clearfix">
        <div class="col-md-12 mb20">
            <strong class="font-18">
                <?php echo lang("expense") . " # " . format_to_date($expense_info->expense_date, false); ?>
            </strong>
            <div>
                <?php
        ...
        <?php if ($expense_info->category_title) { ?>
            <div class="col-md-12 mb15">
                ...
                <?php echo $expense_info->category_title; ?>
            </div>
        <?php } ?>
        ...
        <?php if ($expense_info->project_title) { ?>
            <div class="col-md-12 mb15">
                ...
                <?php echo anchor(get_uri("projects/view/" . $expense_info->project_id), $expense_info->project_title); ?>
            </div>
        <?php } ?>
        ...
        <?php if ($expense_info->linked_user_name) { ?>
            <div class="col-md-12 mb15">
                ...
                <?php echo get_team_member_profile_link($expense_info->user_id, $expense_info->linked_user_name); ?>
            </div>
        <?php } ?>
            ...
            foreach ($custom_fields_list as $data) {
                if ($data->value) {
                    ...
                    <div class="col-md-12 mb15">
                        ...
                        <?php echo $this->load->view("custom_fields/output_" . $data->field_type, array("value" => $data->value), true); ?>
                    </div>
                    <?php
                }
            }
        ...
        <?php if ($expense_info->recurring_expense_id) { ?>
            <div class="col-md-12 mb15">
                <strong>
                    <?php echo lang('created_from') . ": "; ?>
                </strong>
                <?php
                echo modal_anchor(get_uri("expenses/expense_details"), lang("original_expense"), array("title" => lang("expense_details"), "data-post-id" => $expense_info->recurring_expense_id));
                ?>
            </div>
        <?php } ?>
        ...
        <?php if ($expense_info->recurring) { ?>
            ...
            <div class="col-md-12 mb15">
                ...
                <?php echo $expense_info->repeat_every . " " . lang("interval_" . $expense_info->repeat_type); ?>
            </div>

            <div class="col-md-12 mb15">
                <strong>
                    <?php echo lang("cycles") . ": "; ?>
                </strong> <span class="<?php echo $recurring_cycle_class; ?>">
                    <?php echo $cycles; ?>
                </span>
            </div>
            ...
            <?php if (!$recurring_stopped && (int) $expense_info->next_recurring_date) { ?>
                <div class="col-md-12 mb15">
                    ...
                    <?php echo format_to_date($expense_info->next_recurring_date, false); ?>
                </div>
            <?php } ?>
        <?php } ?>
    </div>
...
<div class="modal-footer">
    ...
    echo modal_anchor(
        ...
        "<i class='fa fa-pencil'></i> " . lang("edit_expense"),
        array(
