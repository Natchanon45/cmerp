...
<script type="text/javascript">
    ...
    async function processBinding() {
        ...
        $(".select-order").on("change", function () {
            ...
            let selectNameItems = parent.find('[name="product_name[]"]');
            let optionItems = [];
            ...
            if (self.val() == 'SV') {
                ...
                selectNameItems.removeClass('pointer-none hide');
            }
            ...
            if (self.val() == 'RM') {
                ...
                if (optionItems.length) {
                    ...
                    selectNameItems.addClass('pointer-none hide');
            ...
            await tableBody.append(`
                <tr>
                    ...
                    <td>
                        ...
                        <input name="product_name[]" class="form-control pointer-none hide" maxlength="40">
                    </td>
                    <td>
