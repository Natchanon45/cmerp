<?php echo form_open(get_uri("Materialrequests/save"), array("id" => "pr-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    ...
    <?php } else { ?>
        <div class="form-group">
            ...
            <div class="col-md-9">
                <?php
                echo form_dropdown("pr_buyer_id", $buyers_dropdown, array($model_info->requester_id), "class='select2 validate-hidden' id='pr_buyer_id' data-rule-required='true', data-msg-required='" . lang('field_required') . "'");
                ?>
            </div>
        </div>
    <?php } ?>
        ...
        $("#pr-form").appForm({
            onSuccess: function (result) {
                if (typeof RELOAD_VIEW_AFTER_UPDATE !== "undefined" && RELOAD_VIEW_AFTER_UPDATE) {
                    ...
                    window.location = "<?php echo site_url('materialrequests/view'); ?>/" + result.id;
                }
            }
        });
