<div id="page-content" class="p20 clearfix">
	...
	<div class="panel clearfix">
		<ul id="pr-tabs" data-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
			...
			<li><a id="monthly-pr-button" class="active" role="presentation" href="javascript:void();" data-target="#monthly-purchaserequests"><?php echo lang("monthly"); ?></a></li>
			<li><a id="yearly-pr-button" role="presentation" href="<?php echo_uri("materialrequests/yearly/"); ?>" data-target="#yearly-purchaserequests"><?php echo lang('yearly'); ?></a></li>
			<div class="tab-title clearfix no-border">
				<div class="title-button-group">
					<?php if ($create_material_request) echo $buttonTops; ?>
				</div>
			</div>
		</ul>
		...
		<div class="tab-content">
			...
			<div role="tabpanel" class="tab-pane fade" id="yearly-purchaserequests">
				<div class="table-responsive">
					<table id="yearly-pr-table" class="display" cellspacing="0" width="100%"></table>
				</div>
			</div>
		</div>
	</div>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		loadPrTable("#yearly-pr-table", "yearly");
