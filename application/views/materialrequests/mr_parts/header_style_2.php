<table style="color: #444; width: 100%;">
    <tr class="invoice-preview-header-row">
        <td class="invoice-info-container" style="width: 40%; vertical-align: top;"><?php
            ...
            $this->load->view('materialrequests/mr_parts/pr_info', $data);
            ?>
        </td>
    ...
    <tr>
        <td><?php
            $this->load->view('materialrequests/mr_parts/pr_to', $data);
            ?>
        </td>
        <td></td>
        <td><?php
            $this->load->view('materialrequests/mr_parts/pr_from', $data);
            ?>
        </td>
    </tr>
</table>