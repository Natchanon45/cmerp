<?php echo form_open(get_uri("materialrequests/save_discount"), array("id" => "discount-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    <input type="hidden" name="pr_id" value="<?php echo $model_info->id; ?>" />
    ...
    $(document).ready(function () {
        $("#discount-form").appForm({
            onSuccess: function (result) {
                if (result.success && result.order_total_view) {
