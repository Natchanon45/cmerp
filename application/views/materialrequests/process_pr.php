        ...
        <div class="process-pr-preview">
            <div class="panel panel-default">
                ...
                <div class="page-title clearfix">
                    <h1> <?php echo lang('process_request_materialrequest'); ?></h1>
                    <div class="title-button-group">
                       <a href="<?php echo get_uri("materialrequests");?>" class="btn btn-default"><?php echo lang('back_to_request_materialrequest');?></a>
                    </div>
                </div>
                    ...
                    <div class="m15 pb15 mb30">
                        ...
                        <div class="clearfix">
                            ...
                            <!-- <div class="pull-right" id="pr-total-section">
                                <?php //$this->load->view("materialrequests/processing_pr_total_section"); ?>
                            </div> -->
                        </div>
                    </div>
                ...
                <div class="panel-footer clearfix">
                    <?php if(!$mr_id) {?>
                    <button type="submit" class="btn btn-primary pull-right ml10"><span class="fa fa-check-circle"></span> <?php echo lang('place_order_materialrequest'); ?></button>
                    <?php }else{ ?>
                    <?php echo anchor( get_uri("materialrequests/view/$mr_id"), "<i class='fa fa-check-circle'></i> " . lang('place_order_materialrequest'), array("class" => "btn btn-primary pull-right ml10")); ?> 
                    <?php } ?>
                    <?php echo modal_anchor(get_uri("materialrequests/fin_item_modal_form"), "<i class='fa fa-plus-circle'></i>" . lang('add_internal_items1'), array("class" => "btn btn-default pull-right", "title" => lang('add_internal_items1'), "data-post-id" => 0, "data-post-mr_id" => $mr_id,'data-post-item_type'=>'mtr'));?>
                    <?php //echo anchor(get_uri("pr_items/grid_view?mr_id=$mr_id"), "<i class='fa fa-plus-circle'></i> " . lang('add_internal_items1'), array("class" => "btn btn-default pull-right")); ?> 
                    <?php echo modal_anchor(get_uri("materialrequests/item_modal_form"), "<i class='fa fa-plus-circle'></i>" . lang('add_materials'), array("class" => "btn btn-default pull-right", "title" => lang('add_materials'), "data-post-id" => 0, "data-post-mr_id" => $mr_id,'data-post-item_type'=>'mtr'));?>
                </div>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $("#pr-item-table").appTable({
                    source: '<?php echo_uri("materialrequests/item_list_data_of_login_user".($mr_id?"/".$mr_id:"")) ?>',
                    order: [[0, "asc"]],
                    hideTools: true,
                    displayLength: 100,
                    columns: [
