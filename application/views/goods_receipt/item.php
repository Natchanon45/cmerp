...
<div class="general-form modal-body clearfix">
    <div class="form-group">
        <label for="product_name" class=" col-md-3">
            <?php echo lang('item'); ?>
        </label>
        <div class="col-md-9">
            ...
            <input 
                ...
                placeholder="<?php echo lang('select_or_create_new_item'); ?>" 
                class="form-control <?php if (isset($item_id) && !empty($item_id)) { echo 'pointer-none'; } ?> <?php if (isset($po_id) && !empty($po_id)) { echo 'pointer-none'; } ?>" 
            />
        </div>
    </div>
    <div class="form-group">
        <label for="product_description" class="col-md-3">
            <?php echo lang('description'); ?>
        </label>
        <div class=" col-md-9">
            <textarea id="product_description" class="form-control <?php if (isset($po_id) && !empty($po_id)) { echo 'pointer-none'; } ?>"><?php echo $product_description; ?></textarea>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-md-9">
            <input 
                ...
                class="form-control numb <?php if (isset($po_id) && !empty($po_id)) { echo 'pointer-none'; } ?>" 
            />
        </div>
    </div>
    <div class="form-group">
        <label for="unit" class=" col-md-3">
        ...
        <div class="col-md-9">
            <input 
                ...
                value="<?php echo $unit; ?>" 
                placeholder="หน่วย" 
                class="form-control <?php if (isset($po_id) && !empty($po_id)) { echo 'pointer-none'; } ?>" 
            />
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-md-9">
            <input 
                type="text" id="price" value="<?php echo $price; ?>" 
                placeholder="<?php echo lang('rate'); ?>" 
                class="form-control numb <?php if (isset($po_id) && !empty($po_id)) { echo 'pointer-none'; } ?>" 
            />
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-md-9">
            <input 
                type="text" id="total_price" value="<?php echo $total_price; ?>" 
                placeholder="<?php echo lang('rate'); ?>" 
                class="form-control numb <?php if (isset($po_id) && !empty($po_id)) { echo 'pointer-none'; } ?>" readonly 
            />
        </div>
    </div>
</div>
<div class="modal-footer">
    <button type="button" id="x" class="btn btn-default" data-dismiss="modal"><span class="fa fa-close"></span>
        <?php echo lang('close'); ?>
    </button>
    <?php if ($doc_status == 'N'): ?>
        <?php if ($po_id == null): ?>
