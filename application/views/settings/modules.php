        ...
        <div class="col-sm-9 col-lg-10">
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label for="module_order" class="col-md-2 col-xs-8 col-sm-4"><?php echo lang('order'); ?></label>
                        <div class="col-md-10 col-xs-4 col-sm-8">
                            <?php
                    ...
                    <div class="form-group">
                        <label for="module_purchaserequest" class="col-md-2 col-xs-8 col-sm-4"><?php echo lang('purchaserequests'); ?></label>
                        <div class="col-md-10 col-xs-4 col-sm-8">
                            <?php
                            echo form_checkbox("module_purchaserequests", "1", get_setting("module_purchaserequests") ? true : false, "id='module_purchaserequest' class='ml15'");
                            ?>                       
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="module_purchaseorder" class="col-md-2 col-xs-8 col-sm-4"><?php echo lang('po'); ?></label>
                        <div class="col-md-10 col-xs-4 col-sm-8">
                            <?php
                            echo form_checkbox("module_po", "1", get_setting("module_po") ? true : false, "id='module_po' class='ml15'");
                            ?>                       
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="module_payment_voucher" class="col-md-2 col-xs-8 col-sm-4"><?php echo lang('payment_vouchers'); ?></label>
                        <div class="col-md-10 col-xs-4 col-sm-8">
                            <?php
                            echo form_checkbox("module_payment_voucher", "1", get_setting("module_payment_voucher") ? true : false, "id='module_payment_voucher' class='ml15'");
                            ?>                       
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="module_receipt_taxinvoices" class="col-md-2 col-xs-8 col-sm-4"><?php echo lang('receipt_taxinvoices'); ?></label>
                        <div class="col-md-10 col-xs-4 col-sm-8">
                            <?php
                            echo form_checkbox("module_receipt_taxinvoices", "1", get_setting("module_receipt_taxinvoices") ? true : false, "id='module_receipt_taxinvoices' class='ml15'");
                            ?>                       
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="module_delivery" class="col-md-2 col-xs-8 col-sm-4"><?php echo lang('delivery'); ?></label>
                        <div class="col-md-10 col-xs-4 col-sm-8">
                            <?php
                    ...
                    <div class="form-group">
                        <label for="module_stock" class="col-md-2 col-xs-8 col-sm-4"><?php echo lang('stock_management'); ?></label>
                        <div class="col-md-10 col-xs-4 col-sm-8">
                            <?php
                            echo form_checkbox("module_stock", "1", get_setting("module_stock") ? true : false, "id='module_stock' class='ml15'");
                            ?>                       
                        </div>
                    </div>
