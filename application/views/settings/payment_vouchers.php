<div id="page-content" class="p20 clearfix">
    <div class="row">
        <div class="col-sm-3 col-lg-2">
            <?php
            $tab_view['active_tab'] = "payment_vouchers";
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <label for="logo" class=" col-md-2"><?php echo lang('invoice_logo'); ?> (300x100) </label>
                        <div class=" col-md-10">
                            ...
                            <div class="mt10 ml10 pull-left">
                                ...
                                ?>
                                <label for="invoice_logo_file_upload" class="btn btn-default btn-xs">
                    ...
                    <div class="form-group">
                        <label for="payment_voucher_prefix" class=" col-md-2"><?php echo lang('payment_voucher_prefix'); ?></label>
                        <div class=" col-md-10">
                            <?php
                            echo form_input(array(
                                "id" => "payment_voucher_prefix",
                                "name" => "payment_voucher_prefix",
                                "value" => get_setting("payment_voucher_prefix"),
                                "class" => "form-control",
                                "placeholder" => strtoupper(lang("payment_voucher")) . " #"
                            ));
                            ?>
                        </div>
                    </div>
