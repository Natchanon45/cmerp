...
if (get_setting("module_po") == "1") {
    $settings_menu["setup"][] = array("name" => "po", "url" => "settings/po");
}

if (get_setting("module_receipt_taxinvoices") == "1") {
    $settings_menu["setup"][] = array("name" => "receipt_taxinvoices", "url" => "settings/rt");
}
...
if (get_setting("module_purchaserequests") == "1") {
    $settings_menu["setup"][] = array("name" => "purchaserequest", "url" => "settings/pr");
}
