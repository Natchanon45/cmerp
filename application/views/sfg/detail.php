<div class="page-title clearfix no-border bg-off-white">
    <h1><a class="title-back" href="<?php echo get_uri('items'); ?>"><i class="fa fa-chevron-left" aria-hidden="true"></i></a>รายการสินค้ากึ่งสำเร็จ - <?php echo $model_info->title; ?></h1>
</div>
<div id="page-content" class="clearfix">
    <ul id="client-tabs" data-toggle="ajax-tab" class="nav nav-tabs" role="tablist" style="background:#ffffff;">
        ...
        <li><a role="presentation" href="<?php echo_uri("stock/item_pricings/" . $model_info->id); ?>" data-target="#sfg-pricings"><?php echo lang('stock_item_pricings'); ?></a></li>
