...
<div id="page-content" class="clearfix">
  <ul id="client-tabs" data-toggle="ajax-tab" class="nav nav-tabs" role="tablist" style="background: #ffffff;">
    <li>
      <a role="presentation" href="<?php echo_uri("sfg/restock_view_info/" . $restock_item_info->id); ?>" data-target="#restock-info">
        <?php echo lang('stock_restock_item_info'); ?>
      </a>
    </li>
    <li><a role="presentation" href="<?php echo_uri("sfg/restock_item_details/" . $restock_item_info->id); ?>" data-target="#restock-details">
