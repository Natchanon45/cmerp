<?php echo form_open(get_uri("sfg/restock_item_details_modal_addedit/save"), array("id" => "remaining-form", "class" => "general-form", "role" => "form")); ?>
  ...
  <div class="modal-body clearfix" id="temp-container">
    ...
    <div class="form-group">
      <label for="item_id" class="col-md-3">
        <?php echo "สินค้ากึ่งสำเร็จ" . $readonly; ?>
      </label>
      <div class="col-md-9">
    ...
    <div class="form-group">
      <label for="stock" class="col-md-3">
    ...
    <div class="form-group">
      <label for="remaining" class="col-md-3">
    ...
    <?php if ($can_read_price) { ?>
      ...
      <div class="form-group">
        <label for="priceunit" class="col-md-3">
          <?php echo lang('rate'); ?>
        </label>
        <div class="col-md-9">
          <div class="input-suffix">
    ...
    <div class="form-group">
      <label for="expiration_date" class="col-md-3">
        <?php echo lang('expiration_date'); ?>
      </label>
      <div class="col-md-9" <?php if ($readonly) echo 'style="pointer-events: none;"'; ?>>
        <?php
        $set_expire = array(
          "id" => "expiration_date",
...
<script type="text/javascript">
  $(document).ready(function () {
    <?php if ((empty($model_info->id) && $can_update) || (!empty($model_info->id) && $can_update)) { ?>
      <?php if (!$disabled): ?>
        var uploadUrl = "<?php echo get_uri("sfg/restock_item_details_upload_file"); ?>";
        var validationUri = "<?php echo get_uri("sfg/restock_item_details_validate_file"); ?>";
