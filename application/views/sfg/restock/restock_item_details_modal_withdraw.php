<?php echo form_open(get_uri("sfg/restock_item_details_modal_withdraw/save"), array("id" => "withdraw-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix" id="temp-container">
  ...
  <div class="form-group">
    <label for="material_id" class="col-md-3">
