								...
								<tr>
									...
									<td>
										<?php if ($doc["buyer"] != null)
											echo $doc["buyer"]["first_name"] . " " . $doc["buyer"]["last_name"]; ?>
									</td>
								</tr>
					...
					<div class="summary clear">
						...
						<div class="total_all">
							...
							<?php if ($doc["vat_inc"] == "Y"): ?>
								<div class="row">
									<div class="c1 custom-color"><?php echo lang('value_add_tax'); ?>
							...
							<?php if ($doc["wht_inc"] == "Y"): ?>
								<div class="row wht">
									<div class="c1 custom-color"><?php echo lang('with_holding_tax'); ?>
