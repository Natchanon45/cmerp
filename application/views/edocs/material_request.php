				...
				<div class="header clear">
					...
					<div class="right">
						<div class="docname custom-color">
							<?php echo $mat_req_info->mr_type == 1 ? lang('material_request_document') : lang('fg_request_document'); ?>
						</div>
						<div class="docinfo">
							<table>
								<tr>
							...
							<div class="name">
								<span class="l1">
									<?php if ($mat_req_info->status_id != 4):
										if ($mat_req_info->requester_id != null):
											if (null != $requester_sign = $this->Users_m->getSignature($mat_req_info->requester_id)): ?>
							...
							<div class="name">
								<span class="l1">
									<?php if ($mat_req_info->approved_by != null && $mat_req_info->status_id == 3):
										if (null != $signature = $this->Users_m->getSignature($mat_req_info->approved_by)): ?>
