<div class="panel panel-default">
    <div class="panel-heading clearfix">
        <i class="fa fa fa-file-text-o"></i>&nbsp; <?php echo lang("receipt_taxinvoice_statistics"); ?>
    ...
    <div class="panel-body ">
        <div id="receipt_taxinvoice-payment-statistics-flotchart" style="width: 100%; height: 300px;"></div>
    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        var receipt_taxinvoiceStatisticsFlotchart = function () {
            var receipt_taxinvoices =<?php echo $receipt_taxinvoices; ?>,
                    payments = <?php echo $payments; ?>,
                    dataset = [
                        {
                            data: receipt_taxinvoices,
                        ...
                        {
                            label: "<?php echo lang('receipt_taxinvoice'); ?>",
                            data: receipt_taxinvoices,
                            color: "rgba(220,220,220, 1)",
                            lines: {
                                show: false
            ...
            $.plot($("#receipt_taxinvoice-payment-statistics-flotchart"), dataset, {
                series: {
                    curvedLines: {
                        apply: true,
                        active: true,
        ...
        receipt_taxinvoiceStatisticsFlotchart();
    });
</script>    
