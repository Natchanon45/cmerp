<table id="recurring-receipt_taxinvoice-table" class="display" cellspacing="0" width="100%">   
</table>
<script type="text/javascript">
    ...
    $("#recurring-receipt_taxinvoice-table").appTable({
    source: '<?php echo_uri("receipt_taxinvoices/recurring_list_data") ?>',
            order: [[0, "desc"]],
