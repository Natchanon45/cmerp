...
<div class="modal-body clearfix">
    ...
    <div class="form-group">
        ...
        <div class="col-md-9">
            ...
            ?>
            <a id="receipt_taxinvoice_item_title_dropdwon_icon" tabindex="-1" href="javascript:void(0);" style="color: #B3B3B3;float: right; padding: 5px 7px; margin-top: -35px; font-size: 18px;"><span>×</span></a>
        </div>
    </div>
    <div class="form-group">
