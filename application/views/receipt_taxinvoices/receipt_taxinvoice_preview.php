<div id="page-content" class="p20 clearfix">
    ...
    <div class="receipt_taxinvoice-preview">
        <?php if ($this->login_user->user_type === "client" && $receipt_taxinvoice_total_summary->balance_due >= 1 && count($payment_methods) && !$client_info->disable_online_payment) { ?>
            <div class="panel panel-default  p15 no-border clearfix">
                ...
                <!-- <div class="pull-right">
                    <?php
                        echo "<div class='text-center'>" . anchor("receipt_taxinvoices/download_pdf/" . $receipt_taxinvoice_info->id, lang("download_pdf"), array("class" => "btn btn-default round")) . "</div>"
                    ?>
                </div> -->
        ...
        if ($show_close_preview) {
            echo "<div class='text-center'>" . anchor("receipt_taxinvoices/view/" . $receipt_taxinvoice_info->id, lang("close_preview"), array("class" => "btn btn-default round")) . "</div>";
        }
        ?>
