<div style=" margin: auto;">
    ...
    $discount_row = '<tr>
                        ...
                        <td style="text-align: right; width: 20%; border: 1px solid #fff; background-color: #f4f4f4;">' . to_currency($receipt_taxinvoice_total_summary->discount_total, $receipt_taxinvoice_total_summary->currency_symbol) . '</td>
                    </tr>';
    ?>
</div>
...
<table class="table-responsive" style="width: 100%; color: #444;">            
    ...
    <?php
    foreach ($receipt_taxinvoice_items as $item) {
        ?>
    ...
    <tr>
        ...
        <td style="text-align: right; width: 20%; border: 1px solid #fff; background-color: #f4f4f4;">
            <?php echo to_currency($receipt_taxinvoice_total_summary->receipt_taxinvoice_subtotal, $receipt_taxinvoice_total_summary->currency_symbol); ?>
        </td>
    </tr>
    <?php
    if ($receipt_taxinvoice_total_summary->discount_total && $receipt_taxinvoice_total_summary->discount_type == "before_tax") {
        echo $discount_row;
    }
    ?>    
    <?php if ($receipt_taxinvoice_total_summary->tax) { ?>
        <tr>
            <td colspan="3" style="text-align: right;"><?php echo $receipt_taxinvoice_total_summary->tax_name; ?></td>
            <td style="text-align: right; width: 20%; border: 1px solid #fff; background-color: #f4f4f4;">
                <?php echo to_currency($receipt_taxinvoice_total_summary->tax, $receipt_taxinvoice_total_summary->currency_symbol); ?>
            </td>
        </tr>
    <?php } ?>
    <?php if ($receipt_taxinvoice_total_summary->tax2) { ?>
        <tr>
            <td colspan="3" style="text-align: right;"><?php echo $receipt_taxinvoice_total_summary->tax_name2; ?></td>
            <td style="text-align: right; width: 20%; border: 1px solid #fff; background-color: #f4f4f4;">
                <?php echo to_currency($receipt_taxinvoice_total_summary->tax2, $receipt_taxinvoice_total_summary->currency_symbol); ?>
            </td>
        </tr>
    <?php } ?>
    <?php if ($receipt_taxinvoice_total_summary->tax3) { ?>
        <tr>
            <td colspan="3" style="text-align: right;"><?php echo $receipt_taxinvoice_total_summary->tax_name3; ?></td>
            <td style="text-align: right; width: 20%; border: 1px solid #fff; background-color: #f4f4f4;">
                <?php echo to_currency($receipt_taxinvoice_total_summary->tax3, $receipt_taxinvoice_total_summary->currency_symbol); ?>
            </td>
        </tr>
    <?php } ?>
    <?php
    ...
    <?php if ($receipt_taxinvoice_total_summary->total_paid) { ?>     
        <tr>
            ...
            <td style="text-align: right; width: 20%; border: 1px solid #fff; background-color: #f4f4f4;">
                <?php echo to_currency($receipt_taxinvoice_total_summary->total_paid, $receipt_taxinvoice_total_summary->currency_symbol); ?>
            </td>
        </tr>
    <?php } ?>
    <tr>
        ...
        <td style="text-align: right; width: 20%; background-color: <?php echo $color; ?>; color: #fff;">
            <?php echo to_currency($receipt_taxinvoice_total_summary->balance_due, $receipt_taxinvoice_total_summary->currency_symbol); ?>
        </td>
    </tr>
</table>
<?php if ($receipt_taxinvoice_info->note) { ?>
    <br />
    <br />
    <div style="border-top: 2px solid #f2f2f2; color:#444; padding:0 0 20px 0;"><br /><?php echo nl2br($receipt_taxinvoice_info->note); ?></div>
<?php } else { ?> <!-- use table to avoid extra spaces -->
    <br /><br /><table class="receipt_taxinvoice-pdf-hidden-table" style="border-top: 2px solid #f2f2f2; margin: 0; padding: 0; display: block; width: 100%; height: 10px;"></table>
<?php } ?>
<span style="color:#444; line-height: 14px;">
    <?php echo get_setting("receipt_taxinvoice_footer"); ?>
</span>
