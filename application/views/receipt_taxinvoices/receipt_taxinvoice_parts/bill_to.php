...
<strong><?php echo $client_info->company_name.' '; 
    echo modal_anchor(get_uri("receipt_taxinvoices/modal_form"), "<i class='fa fa-edit' style='color: blue'></i> " , array("title" => lang('edit_receipt_taxinvoice'), "data-post-id" => $receipt_taxinvoice_info->id, "role" => "menuitem", "tabindex" => "-1"));
?> </strong>
<div style="line-height: 3px;"> </div>
<span class="receipt_taxinvoice-meta" style="font-size: 90%; color: #666;">
