...
<div class="form-group">
	<label for="placeholder" class=" col-md-3">
		<?php echo lang("placeholder"); ?>
	</label>
	<div class=" col-md-9">
		<?php
		echo form_input(
...
<?php if (isset($related_to) && $related_to === "tickets"): ?>
	<div class="form-group">
		<label for="example_variable_name" class=" col-md-3">
			<?php echo lang("email_template_variable"); ?>
		</label>
		<div class=" col-md-9">
			<?php if ($model_info->example_variable_name) { ?>
				<input type="hidden" name="example_variable_name"
					value="<?php echo $model_info->example_variable_name; ?>" />
...
<div class="form-group">
	<label for="field_type" class=" col-md-3">
		<?php echo lang("field_type"); ?>
	</label>
	<div class="col-md-9">
		<?php
		$disabled = "";
...
<div id="options_container" class="form-group">
	<label for="options" class=" col-md-3">
...
<div class="form-group">
	<label for="required" class=" col-md-3">
