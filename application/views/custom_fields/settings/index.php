	...
	<div class="row">
		...
		<div class="col-sm-9 col-lg-10">
			...
			<div class="panel panel-default no-border clearfix ">
				...
				<ul id="custom-field-tab" data-toggle="ajax-tab" class="nav nav-tabs bg-white title"
					role="tablist">
					<li class="title-tab">
					...
					<li><a role="presentation" data-related_to="projects"
							href="<?php echo_uri("custom_fields/projects/"); ?>"
							data-target="#custom-field-projects"><?php echo lang('projects'); ?></a></li>
					<li><a role="presentation" data-related_to="tasks"
							href="<?php echo_uri("custom_fields/tasks/"); ?>"
							data-target="#custom-field-tasks"><?php echo lang('tasks'); ?></a></li>
					<li><a role="presentation" data-related_to="team_members"
							href="<?php echo_uri("custom_fields/team_members/"); ?>"
							data-target="#custom-field-team_members"><?php echo lang('team_members'); ?></a></li>
					<li><a role="presentation" data-related_to="tickets"
							href="<?php echo_uri("custom_fields/tickets/"); ?>"
							data-target="#custom-field-tickets"><?php echo lang('tickets'); ?></a></li>
					<li><a role="presentation" data-related_to="invoices"
							href="<?php echo_uri("custom_fields/invoices/"); ?>"
							data-target="#custom-field-invoices"><?php echo lang('invoices'); ?></a></li>
					<li><a role="presentation" data-related_to="events"
							href="<?php echo_uri("custom_fields/events/"); ?>"
							data-target="#custom-field-events"><?php echo lang('events'); ?></a></li>
					<li><a role="presentation" data-related_to="expenses"
							href="<?php echo_uri("custom_fields/expenses/"); ?>"
							data-target="#custom-field-expenses"><?php echo lang('expenses'); ?></a></li>
					<li><a role="presentation" data-related_to="estimates"
							href="<?php echo_uri("custom_fields/estimates/"); ?>"
							data-target="#custom-field-estimates"><?php echo lang('estimates'); ?></a></li>
					<li><a role="presentation" data-related_to="orders"
							href="<?php echo_uri("custom_fields/orders/"); ?>"
							data-target="#custom-field-orders"><?php echo lang('orders'); ?></a></li>
					<li><a role="presentation" data-related_to="timesheets"
							href="<?php echo_uri("custom_fields/timesheets/"); ?>"
							data-target="#custom-field-timesheets"><?php echo lang('timesheets'); ?></a></li>
				...
				<div class="tab-content">
					<div role="tabpanel" class="tab-pane fade active clearfix"
						id="custom-field-clients">
						<div class="panel panel-default mb0 p20">
							<div class="table-responsive general-form">
								<table id="custom-field-table-clients"
									class="display no-thead b-t b-b-only no-hover"
									cellspacing="0" width="100%">
								</table>
							</div>
						</div>
					</div>
					<div role="tabpanel" class="tab-pane fade" id="custom-field-client_contacts">
					</div>
					<div role="tabpanel" class="tab-pane fade" id="custom-field-lead_contacts">
					</div>
			...
			onInitComplete: function () {
				...
				Sortable.create($selector[0], {
					...
					onUpdate: function (e) {
						...
						if (relatedTo == "leads") {
							$.ajax({
								url: '<?php echo_uri("custom_fields/update_field_sort_values_leads") ?>' + "/" + relatedTo,
								type: "POST",
