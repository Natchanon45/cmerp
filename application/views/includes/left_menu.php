<div id="sidebar" class="box-content ani-width preivewzone">
            ...
            ?>
                <li class="<?php echo $active_class . " " . $expend_class . " " . $submenu_open_class . " $devider_class"; ?> main">
                    <a <?php echo $target; ?> href="<?php echo isset($main_menu['is_custom_menu_item']) ? $main_menu['url'] : get_uri($main_menu['url']); ?>">
                        ...
                        <span><?php echo isset($main_menu['is_custom_menu_item']) ? lang($main_menu['name']) : lang($main_menu['name']); ?></span>
                        <?php if ($badge) echo "<span class='badge $badge_class'>$badge</span>"; ?>
                    </a>
                    <?php
                        if ($submenu) {
                            echo "<ul>";
                            foreach ($submenu as $ss=>$s_menu) {
                                if ($ss > 0 && isset($s_menu['name'])) {
                    ...
                    ?>
                        <li>
                            <a <?php echo $sub_menu_target; ?> href="<?php echo isset($s_menu['is_custom_menu_item']) ? $s_menu['url'] : get_uri($s_menu['url']); ?>">
                                ...
                                <span><?php echo isset($s_menu['is_custom_menu_item']) ? lang($s_menu['name']) : lang($s_menu['name']); ?></span>
                            </a>
                        </li>
                    <?php }} echo "</ul>"; } ?>
                </li>
