<div id="page-content" class="p20 clearfix">
    <?php if ($cart_items_count) { ?>
        <div class="process-receipt-preview">
            <div class="panel panel-default">

                <?php echo form_open(get_uri("receipts/place_receipt"), array("id" => "place-receipt-form", "class" => "general-form", "role" => "form")); ?>

                <div class="page-title clearfix">
                    <h1> <?php echo lang('process_receipt'); ?></h1>
                </div>

                <div class="p20">
                    
                    <div class="mb20 ml15 mr15"><?php echo lang("process_receipt_info_message"); ?></div>
                    
                    <div class="m15 pb15 mb30">
                        <div class="table-responsive">
                            <table id="receipt-item-table" class="display mt0" width="100%">            
                            </table>
                        </div>
                        <div class="clearfix">
                            <div class="col-sm-8">
                            ...
                            <div class="pull-right" id="receipt-total-section">
                                <?php $this->load->view("receipts/processing_receipt_total_section"); ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="panel-footer clearfix">
                    <button type="submit" class="btn btn-primary pull-right ml10"><span class="fa fa-check-circle"></span> <?php echo lang('place_receipt'); ?></button>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $("#place-receipt-form").appForm({
                    isModal: false,
                    onSubmit: function () {
                        appLoader.show();
                        $("#place-receipt-form").find('[type="submit"]').attr('disabled', 'disabled');
                    },
                ...
                $("#receipt-item-table").appTable({
                    source: '<?php echo_uri("receipts/item_list_data_of_login_user") ?>',
                    receipt: [[0, "asc"]],
                    hideTools: true,
                    displayLength: 100,
                    columns: [
