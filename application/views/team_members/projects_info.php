...
<script type="text/javascript">
    $(document).ready(function () {
        $("#project-table").appTable({
            ...
            order: [[1, "desc"]],
            printColumns: combineCustomFieldsColumns( [0, 1, 2, 4, 6, 8, 9, 10], '<?php echo $custom_field_headers; ?>'),
            xlsColumns: combineCustomFieldsColumns( [0, 1, 2, 4, 6, 8, 9, 10], '<?php echo $custom_field_headers; ?>')
        });
    });
</script>