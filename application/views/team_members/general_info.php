<div class="tab-content">
    ...
    <div class="panel">
        ...
        <div class="panel-body">
            ...
            <?php echo $addSignalButton ?>
            <br/>
            <?php 
                if($user_info->signature == ''){
                    echo '<br/><label>ลายเซ็นของท่าน : </label><br/>';
                    echo '<img src="'.base_url().'assets/noImage.png" width="100" height="100" >';
                }else{
                    echo '<br/><label>ลายเซ็นของท่าน : </label><br/>';
                    echo '<img src="'.base_url().$user_info->signature.'" width="150" height="150" >';
                }
            ?>
        </div>
