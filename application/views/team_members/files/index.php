<div class="panel">
    <div class="tab-title clearfix">
        ...
        <div class="title-button-group">
            ...
            // echo modal_anchor(get_uri("team_members/modal_form_signature"), "<i class='fa fa-plus-circle'></i> " . "เพิ่มลายเซ็น", array("class" => "btn btn-default", "title" => 'เพิ่มลายเซ็น', "data-post-user_id" => $user_id));
