        ...
        <div class="col-md-12 clearfix">
            ...
            <?php if ($model_info->google_event_id) { ?>
                <div class="pull-right pb10 ">
                    ...
                    <?php echo anchor(get_uri("events/show_event_in_google_calendar/$model_info->google_event_id"), lang("open_in_google_calendar"), array("target" => "_blank")); ?>
                </div>
            <?php } ?>
