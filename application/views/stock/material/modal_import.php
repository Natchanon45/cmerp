<?php 
    echo form_open(
        get_uri("stock/material_save_client_from_excel_file"), 
    ...
    <div id="upload-area">
        <?php
            $this->load->view("includes/multi_file_uploader", array(
                "upload_url" => get_uri("stock/material_upload_excel_file"),
                "validation_url" => get_uri("stock/material_validate_import_file"),
                "max_files" => 1,
...
<div class="modal-footer">
    <?php echo anchor("stock/material_sample_excel_file", "<i class='fa fa-cloud-download'></i> " . lang("download_sample_file"), array("title" => lang("download_sample_file"), "class" => "btn btn-default pull-left")); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $nextButton.click(function () {
            ...
            $.ajax({
                url: "<?php echo get_uri('stock/material_validate_import_file_data') ?>",
                type: 'POST',
                dataType: 'json',
