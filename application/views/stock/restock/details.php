    ...
    <div class="title-button-group">
      ...
      if ($can_create) {
        echo modal_anchor(
          ...
          array("class" => "btn btn-default", "title" => lang('stock_material_add'), "data-post-group_id" => $restock_id)
        );
      }
      ?>
    </div>
...
<script type="text/javascript">
  $(document).ready(function () {
    $("#remaining-table").appTable({
      ...
      <?php if ($can_read_price) { ?>
        printColumns: combineCustomFieldsColumns([0, 1, 3, 4, 5, 6, 7, 8, 9, 10]),
        xlsColumns: combineCustomFieldsColumns([0, 1, 3, 4, 5, 6, 7, 8, 9, 10]),
        summation: [
