  ...
  <div class="modal-body clearfix" id="temp-container">
    ...
    <div class="form-group">
      ...
      <div class="<?php echo $field_column; ?>">
        <select name="material_id" class="form-control select-material" <?php if (!empty($model_info->id) && !empty($model_info->group_id)) { echo 'style="pointer-events:none;"'; } if ($readonly) { echo ' readonly'; } ?> required>
          <?php
