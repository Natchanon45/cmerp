<?php echo form_open(get_uri("stock/restock_item_withdraw_save"), array("id" => "withdraw-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix" id="temp-container">
      ...
      >
        ...
        <?php
          foreach($item_dropdown as $d){
            $selected = '';
            if($d->id == $model_info->item_id) $selected = 'selected';
  ...
  <div class="form-group">
    ...
    <div class="<?php echo $field_column; ?>">
      <div class="input-suffix">
        <input 
          type="number" name="remaining" id="remaining" disabled  
  ...
  <div class="form-group">
    ...
    <div class="<?php echo $field_column; ?>">
      <div class="input-suffix">
        <input 
          type="number" name="ratio" id="ratio" required class="form-control" 
          min="0" max="<?= $model_info->remaining ?>" step="0.0001" value="0" 
        />
        <div class="input-tag"></div>
      </div>
    </div>
