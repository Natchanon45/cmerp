...
<div id="page-content" class="clearfix">
  ...
  <ul id="client-tabs" data-toggle="ajax-tab" class="nav nav-tabs" role="tablist" style="background:#ffffff;">
    <li><a role="presentation" href="<?php echo_uri("stock/supplier_contacts/".$supplier_info->id); ?>" data-target="#supplier-contacts">
      <?php echo lang('stock_contacts'); ?>
    </a></li>
    <li><a role="presentation" href="<?php echo_uri("stock/supplier_info/".$supplier_info->id); ?>" data-target="#supplier-info">
      <?php echo lang('stock_supplier_info'); ?>
    </a></li>
    <?php if(!isset($hidden_menu) || !in_array('supplier-pricings', $hidden_menu)){?>
      <li><a role="presentation" href="<?php echo_uri("stock/supplier_pricings/".$supplier_info->id); ?>" data-target="#supplier-pricings">
        <?php echo lang('stock_supplier_pricings'); ?>
      </a></li>
    <?php }?>
    <li><a role="presentation" href="<?php echo_uri("stock/supplier_files/".$supplier_info->id); ?>" data-target="#supplier-files">
      <?php echo lang('files'); ?>
    </a></li>
  </ul>
