<div class="panel">
  <div class="tab-title clearfix">
    ...
    <div class="title-button-group">
      <?php
        if ($can_update){
          echo modal_anchor(
            get_uri("stock/supplier_file_modal"), 
  ...
  <div class="table-responsive">
    <table id="supplier-file-table" class="display" width="100%"></table>
  </div>
</div>

<script type="text/javascript">
  $(document).ready(function () {
    $("#supplier-file-table").appTable({
      source: '<?php echo_uri("stock/supplier_file_list/" . $supplier_id) ?>',
      order: [[0, "desc"]],
      columns: [
