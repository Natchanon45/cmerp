  ...
  $(document).ready(function () {
    ...
    $("#report-table").appTable({
      ...
      columns: [
        ...
        {title: '<?php echo lang("stock_item_delete"); ?>'},
        ...
        {title: '<?php echo lang("stock_item_remaining"); ?>', class: 'w70 text-right'},
        {title: '<?php echo lang("stock_item_unit"); ?>', class: 'w70 text-right'},
