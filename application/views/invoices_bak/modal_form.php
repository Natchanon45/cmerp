<?php echo form_open( get_uri("invoices/save"), array( "id" => "invoice-form", "class" => "general-form", "role" => "form", 'method' => 'get' )); ?>
...
<div id="invoices-dropzone" class="post-dropzone">
    <div class="modal-body clearfix">
        ...
        <div class="form-group">
            <label for="invoice_note" class=" col-md-3"><?php echo lang('note_new'); ?></label>
            <div class=" col-md-9">
                <?php
