<span class="invoice-info-title" style="font-size:20px; font-weight: bold;background-color: <?php echo $color; ?>; color: #fff;">&nbsp;<?php echo get_invoice_id($invoice_info->doc_no); ?>&nbsp;</span>
...
<span>อ้างอิงจาก : <?php echo $invoice_info->es_doc_no?></span>