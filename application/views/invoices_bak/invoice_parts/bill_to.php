...
<strong><?php echo $client_info->company_name.' '; 
    echo modal_anchor(get_uri("invoices/modal_form"), "<i class='fa fa-edit' style='color: blue'></i> " , array("title" => lang('edit_invoice'), "data-post-id" => $invoice_info->id, "role" => "menuitem", "tabindex" => "-1"));
?> </strong>
<div style="line-height: 3px;"> </div>
