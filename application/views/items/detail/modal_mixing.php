...
<div class="modal-footer">
	...
	<button type="button" class="btn btn-primary" onclick="javascript:duplicate_new_mixing();"><span class="fa fa-check-circle"></span> <?php echo lang('duplicate_to_new_mixing'); ?></button>
	<button type="button" class="btn btn-primary" onclick="javascript:duplicate_to_new_item();"><span class="fa fa-check-circle"></span> <?php echo lang('duplicate_to_new_item'); ?></button>
	<?php } ?>
