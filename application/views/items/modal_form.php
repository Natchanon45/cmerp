...
<div id="items-dropzone" class="post-dropzone">
    <div class="modal-body clearfix">
        ...
        <div class="form-group">
            <label for="barcode" class=" col-md-3"><?php echo lang('stock_material_barcode'); ?></label>
            <div class="col-md-9">
                <?php
                echo form_input(array(
                    "id" => "barcode",
    ...
    <div class="modal-footer">
        ...
        <?php if(@$model_info->id) { ?>
        <button type="button" class="btn btn-primary" onclick="javascript:duplicate();"><span class="fa fa-check-circle"></span> <?php echo lang('duplicate'); ?></button>
        <?php } ?>
