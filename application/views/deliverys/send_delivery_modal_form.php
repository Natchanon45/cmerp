<?php echo form_open(get_uri("deliverys/send_delivery"), array("id" => "send-delivery-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    <input type="hidden" name="id" value="<?php echo $delivery_info->id; ?>" />
    ...
    <div class="form-group">
        <label for="delivery_cc" class=" col-md-3">CC</label>
        <div class="col-md-9">
            <?php
    ...
    <div class="form-group">
        <label for="delivery_bcc" class=" col-md-3">BCC</label>
        <div class="col-md-9">
            <?php
            echo form_input(array(
                "id" => "delivery_bcc",
    ...
    <!-- <div class="form-group ml15">
        <i class='fa fa-check-circle' style="color: #5CB85C;"></i> <?php echo lang('attached') . ' ' . anchor(get_uri("deliverys/download_pdf/" . $delivery_info->id), lang("delivery") . "-$delivery_info->id.pdf", array("target" => "_blank")); ?> 
    </div> -->
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#send-delivery-form .select2').select2();
        $("#send-delivery-form").appForm({
