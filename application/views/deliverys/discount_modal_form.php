<?php echo form_open(get_uri("deliverys/save_discount"), array("id" => "discount-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    <input type="hidden" name="delivery_id" value="<?php echo $model_info->id; ?>" />
    ...
    $(document).ready(function () {
        $("#discount-form").appForm({
            onSuccess: function (result) {
                if (result.success && result.delivery_total_view) {
