<div style=" margin: auto;">
    ...
    $discount_row = '<tr>
                        ...
                        <td style="text-align: right; width: 20%; border: 1px solid #fff; background-color: #f4f4f4;">' . to_currency($delivery_total_summary->discount_total, $delivery_total_summary->currency_symbol) . '</td>
                    </tr>';
    ?>
</div>
...
<table class="table-responsive" style="width: 100%; color: #444;">            
    ...
    <tr>
        ...
        <td style="text-align: right; width: 20%; border: 1px solid #fff; background-color: #f4f4f4;">
            <?php echo to_currency($delivery_total_summary->delivery_subtotal, $delivery_total_summary->currency_symbol); ?>
        </td>
    </tr>
    <?php
    if ($delivery_total_summary->discount_total && $delivery_total_summary->discount_type == "before_tax") {
        echo $discount_row;
    }
    ?>  
    <?php if ($delivery_total_summary->tax) { ?>
        <tr>
            <td colspan="3" style="text-align: right;"><?php echo $delivery_total_summary->tax_name; ?></td>
            <td style="text-align: right; width: 20%; border: 1px solid #fff; background-color: #f4f4f4;">
                <?php echo to_currency($delivery_total_summary->tax, $delivery_total_summary->currency_symbol); ?>
            </td>
        </tr>
    <?php } ?>
    <?php if ($delivery_total_summary->tax2) { ?>
        <tr>
            <td colspan="3" style="text-align: right;"><?php echo $delivery_total_summary->tax_name2; ?></td>
            <td style="text-align: right; width: 20%; border: 1px solid #fff; background-color: #f4f4f4;">
                <?php echo to_currency($delivery_total_summary->tax2, $delivery_total_summary->currency_symbol); ?>
            </td>
        </tr>
    <?php } ?>
    <?php
    ...
    <tr>
        ...
        <td style="text-align: right; width: 20%; background-color: <?php echo $color; ?>; color: #fff;">
            <?php echo to_currency($delivery_total_summary->delivery_total, $delivery_total_summary->currency_symbol); ?>
        </td>
    </tr>
</table>
<?php if ($delivery_info->note) { ?>
    <br />
    <br />
    <div style="border-top: 2px solid #f2f2f2; color:#444; padding:0 0 20px 0;"><br /><?php echo nl2br($delivery_info->note); ?></div>
