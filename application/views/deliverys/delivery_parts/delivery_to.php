...
<strong><?php echo $client_info->company_name.' '; 
   echo modal_anchor(get_uri("deliverys/modal_form"), "<i class='fa fa-edit' style='color: blue'></i>", array("title" => lang('edit_delivery'), "data-post-id" => $delivery_info->id, "role" => "menuitem", "tabindex" => "-1"));
   ?> </strong>
<div style="line-height: 3px;"> </div>
