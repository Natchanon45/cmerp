...
//
        ...
        $ignore_permission_classes = ["test", "accounting", "quotations", "billing_notes", "invoices", "tax_invoices", "receipts", "payment_voucher", "credit_notes", "debit_notes", "clients", "notes"];
