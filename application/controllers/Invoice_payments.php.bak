...
(
    ...
    [invoice_payment_date] => 2022-02-24
    [invoice_payment_amount] => 33443
    [invoice_payment_note] => dfsdfsfds
)
...
/*
        ...
        // var_dump($view_data['invoices_dropdown']);exit;
		...
		$view_data['dsdfsdsfads'] = form_dropdown( "invoice_id", $view_data['invoices_dropdown'], "", "class='select2 validate-hidden' id='invoice_id' data-rule-required='true' data-msg-required='" . lang('field_required') . "' ");
