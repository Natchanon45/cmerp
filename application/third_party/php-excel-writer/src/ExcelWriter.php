...
require_once(APPPATH . "third_party/php-excel-writer/src/ContentTypes.php");
require_once(APPPATH . "third_party/php-excel-writer/src/Sheet.php");
require_once(APPPATH . "third_party/php-excel-writer/src/Writer.php");
require_once(APPPATH . "third_party/php-excel-writer/src/Helpers/ExcelHelper.php");
require_once(APPPATH . "third_party/php-excel-writer/src/DocProps/App.php");
require_once(APPPATH . "third_party/php-excel-writer/src/DocProps/Core.php");
require_once(APPPATH . "third_party/php-excel-writer/src/Xl/Workbook.php");
require_once(APPPATH . "third_party/php-excel-writer/src/Xl/Styles.php");
require_once(APPPATH . "third_party/php-excel-writer/src/Xl/SharedStrings.php");
require_once(APPPATH . "third_party/php-excel-writer/src/Xl/Worksheets/SheetXml.php");
require_once(APPPATH . "third_party/php-excel-writer/src/Rels/Relationships.php");
