...
$autoload['model'] = array(
    ...
    'Receipts_model',
    'Order_status_model',
    'Purchaserequests_model',
    'Pr_items_model',
    'Pr_status_model',
    'Payment_vouchers_model',
    'Payment_voucher_items_model',
    'Payment_voucher_payments_model',
    'Labels_model',
    'Verification_model',
    'Item_categories_model',
    'Receive_vouchers_model',
    'Receive_voucher_payments_model',
    'Resources_model',
    'Bom_suppliers_model',
    'Bom_supplier_contacts_model',
    'Bom_supplier_files_model',
    'Bom_materials_model',
    'Bom_material_pricings_model',
    'Bom_material_files_model',
    'Bom_stock_groups_model',
    'Bom_stocks_model',
    'Bom_item_groups_model',
    'Bom_item_stocks_model',
    'Bom_item_mixing_groups_model',
    'Bom_project_item_materials_model',
    'Bom_project_item_items_model',
    'Items_model',
    'Bom_item_model',
